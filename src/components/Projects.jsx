    ...
    const projects = [
        {
            ...
            description: "A secure backend system to manage user subscriptions with CRUD operations. Implemented role-based access, authentication, and validation ensuring consistent data operations.",
        ...
        },
        {
            ...
            description: "Responsive movie browsing application with dynamic UI components. Integrates external APIs for real-time data and features efficient state management and responsive design.",
                        ...
                        <div key={index} style={styles.card} className="project-card">
                            <div style={styles.content}>
                                <div style={styles.projectHeader}>
                                    ...
                                    <div style={styles.externalLinks}>
                                        <a href={project.links.github} target="_blank" rel="noopener noreferrer" className="link-hover" aria-label="GitHub">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                                        </a>
                                        <a href={project.links.demo} target="_blank" rel="noopener noreferrer" className="link-hover" aria-label="Live Demo">
                            ...
                            <ul style={styles.techList}>
                                {project.tech.map((item, i) => (
                                    <li key={i} style={styles.techItem}>{item}</li>
                                ))}
                            </ul>
                        </div>
                    ))}
